...
List<AnotherServicesModel>anotherServicesList=[
  AnotherServicesModel(title: 'إرشادات', fct: (){navigateForward(GuidesForHajjiScreen());}, image: 'assets/images/guides.png'),
  AnotherServicesModel(title: 'وسائل النقل', fct: (){}, image: 'assets/images/bus.png'),
