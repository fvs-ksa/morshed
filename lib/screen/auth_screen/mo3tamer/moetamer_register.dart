                              ...
                              children: [
                                CustomTextField(
                                    ...
                                    validator: (val){
                                      if(val.isEmpty||val==null){
                                        return 'برجاء ادخال الاسم كامل بالعربي';
                                      }
                                      return null;
                                    },
                                ...
                                CustomTextField(
                                    ...
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال الاسم كامل بالانجليزية';
                                      }
                                      return null;
                                    },
                                    labelText: LocaleKeys
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CustomTextField(
                                          validator: (String val){
                                            if(val.isEmpty){
                                              return 'برجاء ادخال تاريخ الميلاد';
                                            }
                                            return null;
                                          },
                                          minHeight: 80.h,
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال رقم جواز السفر';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال رقم التأشيرة';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال رقم الحدود | الإقامة | الهويه الوطنية';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CustomTextField(
                                          validator: (String val){
                                            if(val.isEmpty){
                                              return 'برجاء ادخال تاريخ الوصول';
                                            }
                                            return null;
                                          },
                                          minHeight: 80.h,
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CustomTextField(
                                          validator: (String val){
                                            if(val.isEmpty){
                                              return 'برجاء ادخال تاريخ المغادرة';
                                            }
                                            return null;
                                          },
                                          minHeight: 80.h,
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال اسم الفندق في مكه المكرمه';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CustomTextField(
                                            validator: (String val){
                                              if(val.isEmpty){
                                                return 'برجاء تحديد موقع الفندق في مكه المكرمه';
                                              }
                                              return null;
                                            },
                                            minHeight: 80.h,
                                            ...
                                            keyboardType:
                                            TextInputType.phone,
                                            labelText: 'موقع الفندق في مكه المكرمه',
                                            controller:
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء ادخال اسم الفندق في المدينه المنوره';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CustomTextField(
                                            validator: (String val){
                                              if(val.isEmpty){
                                                return 'برجاء تحديد موقع الفندق في المدينه المنوره';
                                              }
                                              return null;
                                            },
                                            minHeight: 80.h,
                                            ...
                                            labelText: 'موقع الفندق في المدينه المنوره',
                                            // hintText: 'رقم الجوال',
                                            controller:
                                ...
                                CustomTextField(
                                    validator: (String val){
                                      if(val.isEmpty){
                                        return 'برجاء تأكيد الرقم السري';
                                      }
                                      return null;
                                    },
                                    minHeight: 80.h,
