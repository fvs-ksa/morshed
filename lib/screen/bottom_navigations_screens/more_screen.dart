    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          //   child: Padding(
          //     padding:  EdgeInsetsDirectional.symmetric(horizontal: size.width*0.03,vertical: size.width*0.03),
          //     child: Column(
          //       children: [
          //         Card(
          //           elevation:2,
          ...
          //           child: Container(
          //             height: size.height*0.07,
          //             padding: EdgeInsetsDirectional.only(start: size.width*0.05,top: size.height*0.01,bottom: size.height*0.01),
          //             decoration: BoxDecoration(borderRadius: BorderRadius.circular(15.sp)),
          //             child: Row(
          //               children: [
          //                 SvgPicture.asset('assets/svg/me.svg'),
          //                 SizedBox(width: size.width*0.03,),
          //                 Text('الحساب',style: Theme.of(context).textTheme.bodyText2,),
          //               ],
          //             ),
          //           ),
          //         )
