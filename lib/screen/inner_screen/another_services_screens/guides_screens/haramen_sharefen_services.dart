                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(harameenServices.harameenServicesModel.data![index].title ??'',softWrap: true,)
                    ],
                  ),
                  Text(harameenServices.harameenServicesModel.data![index].content ??'',softWrap: true,)
                ],
              );
